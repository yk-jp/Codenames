...
export const clickedCardStyleForSpymasterAndOperative = {
  "ASSASIN": { text: "text-dark", bg: ["bg-dark", "stopHover"] },
  "BYSTANDER": { text: "text-success", bg: ["bg-success", "stopHover"] },
  "RED": { text: "text-danger", bg: ["bg-danger", "stopHover"] },
  "BLUE": { text: "text-primary", bg: ["bg-primary", "stopHover"] },
  "NO TEAM": { text: "text-white", bg: [""] },
  "disabled": true
};

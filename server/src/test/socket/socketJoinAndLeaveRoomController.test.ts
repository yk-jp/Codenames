...
const playerId8 = "id8";
// operative
const player1 = new Operative("test1", playerId1, "RED");
const player2 = new Operative("test2", playerId2, "RED");
const player3 = new Operative("test3", playerId3, "RED");
const player4 = new Operative("test4", playerId4, "RED");
const player5 = new Operative("test5", playerId5, "RED");
const player6 = new Operative("test6", playerId6, "RED");
const operatives = [player1, player2, player3, player4, player5, player6];
// spymaster
const player7 = new Spymaster("test7", playerId7, "RED");
const player8 = new Spymaster("test8", playerId8, "RED");
